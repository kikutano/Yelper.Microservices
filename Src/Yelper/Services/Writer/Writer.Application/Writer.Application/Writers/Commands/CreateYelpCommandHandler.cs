...
public sealed class CreateYelpCommandHandler : IRequestHandler<CreateYelpCommand, ErrorOr<Unit>>
{
    ...
    public async Task<ErrorOr<Unit>> Handle(CreateYelpCommand request, CancellationToken cancellationToken)
    {
